    ...
    <div className="min-h-screen bg-gray-100">
      <main className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900">Agreement Dashboard</h1>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Pending Signatures</dt>
          ...
          {/* Recent Agreements */}
          <div className="mt-8">
            <h2 className="text-lg font-medium text-gray-900">Recent Agreements</h2>
                ...
                {[1, 2, 3].map((item) => (
                  <li key={item} className="px-6 py-4 hover:bg-gray-50">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-medium text-indigo-600">Service Agreement #{item}</p>
